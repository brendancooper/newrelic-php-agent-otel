...
STD_PHP_INI_ENTRY_EX("newrelic.framework.wordpress.hooks_skip_filename",
                     ...
                     NR_PHP_REQUEST,
                     nr_string_mh,
                     ini.wordpress_hooks_skip_filename,
                     zend_newrelic_globals,
                     newrelic_globals,
                     0)
...
STD_PHP_INI_ENTRY_EX("newrelic.transaction_tracer.capture_attributes",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.transaction_tracer_capture_attributes,
                     zend_newrelic_globals,
                     newrelic_globals,
                     nr_enabled_disabled_dh)
STD_PHP_INI_ENTRY_EX("newrelic.transaction_tracer.attributes.enabled",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.transaction_tracer_attributes.enabled,
                     zend_newrelic_globals,
                     newrelic_globals,
                     nr_enabled_disabled_dh)
STD_PHP_INI_ENTRY_EX("newrelic.transaction_tracer.attributes.include",
                     ...
                     NR_PHP_REQUEST,
                     nr_string_mh,
                     ini.transaction_tracer_attributes.include,
                     zend_newrelic_globals,
                     newrelic_globals,
                     0)
STD_PHP_INI_ENTRY_EX("newrelic.transaction_tracer.attributes.exclude",
                     ...
                     NR_PHP_REQUEST,
                     nr_string_mh,
                     ini.transaction_tracer_attributes.exclude,
                     zend_newrelic_globals,
                     newrelic_globals,
                     0)
...
STD_PHP_INI_ENTRY_EX("newrelic.error_collector.ignore_user_exception_handler",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.ignore_user_exception_handler,
                     zend_newrelic_globals,
                     newrelic_globals,
                     nr_yes_no_dh)
STD_PHP_INI_ENTRY_EX(
    ...
    NR_PHP_REQUEST,
    nr_boolean_mh,
    ini.ignore_framework_error_exception_handler,
    zend_newrelic_globals,
    newrelic_globals,
    nr_yes_no_dh)
...
STD_PHP_INI_ENTRY_EX("newrelic.error_collector.capture_attributes",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.error_collector_capture_attributes,
                     zend_newrelic_globals,
                     newrelic_globals,
                     nr_enabled_disabled_dh)
STD_PHP_INI_ENTRY_EX("newrelic.error_collector.attributes.enabled",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.error_collector_attributes.enabled,
                     zend_newrelic_globals,
                     newrelic_globals,
                     nr_enabled_disabled_dh)
STD_PHP_INI_ENTRY_EX("newrelic.error_collector.attributes.include",
                     ...
                     NR_PHP_REQUEST,
                     nr_string_mh,
                     ini.error_collector_attributes.include,
                     zend_newrelic_globals,
                     newrelic_globals,
                     0)
STD_PHP_INI_ENTRY_EX("newrelic.error_collector.attributes.exclude",
                     ...
                     NR_PHP_REQUEST,
                     nr_string_mh,
                     ini.error_collector_attributes.exclude,
                     zend_newrelic_globals,
                     newrelic_globals,
                     0)
...
STD_PHP_INI_ENTRY_EX("newrelic.analytics_events.capture_attributes",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.analytics_events_capture_attributes,
                     zend_newrelic_globals,
                     newrelic_globals,
                     nr_enabled_disabled_dh)
STD_PHP_INI_ENTRY_EX("newrelic.transaction_events.enabled",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.transaction_events_enabled,
                     zend_newrelic_globals,
                     newrelic_globals,
                     nr_enabled_disabled_dh)
...
STD_PHP_INI_ENTRY_EX("newrelic.transaction_events.attributes.enabled",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.transaction_events_attributes.enabled,
                     zend_newrelic_globals,
                     newrelic_globals,
                     nr_enabled_disabled_dh)
STD_PHP_INI_ENTRY_EX("newrelic.transaction_events.attributes.include",
                     ...
                     NR_PHP_REQUEST,
                     nr_string_mh,
                     ini.transaction_events_attributes.include,
                     zend_newrelic_globals,
                     newrelic_globals,
                     0)
STD_PHP_INI_ENTRY_EX("newrelic.transaction_events.attributes.exclude",
                     ...
                     NR_PHP_REQUEST,
                     nr_string_mh,
                     ini.transaction_events_attributes.exclude,
                     zend_newrelic_globals,
                     newrelic_globals,
                     0)
...
STD_PHP_INI_ENTRY_EX("newrelic.custom_events.max_samples_stored",
                     ...
                     ini.custom_events_max_samples_stored,
                     zend_newrelic_globals,
                     newrelic_globals,
                     0)
...
STD_PHP_INI_ENTRY_EX("newrelic.datastore_tracer.instance_reporting.enabled",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.instance_reporting_enabled,
                     zend_newrelic_globals,
                     newrelic_globals,
                     nr_enabled_disabled_dh)
STD_PHP_INI_ENTRY_EX(
    ...
    NR_PHP_REQUEST,
    nr_boolean_mh,
    ini.database_name_reporting_enabled,
    zend_newrelic_globals,
    newrelic_globals,
    nr_enabled_disabled_dh)
...
STD_PHP_INI_ENTRY_EX("newrelic.browser_monitoring.auto_instrument",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.browser_monitoring_auto_instrument,
                     zend_newrelic_globals,
                     newrelic_globals,
                     nr_enabled_disabled_dh)
...
STD_PHP_INI_ENTRY_EX("newrelic.browser_monitoring.capture_attributes",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.browser_monitoring_capture_attributes,
                     zend_newrelic_globals,
                     newrelic_globals,
                     nr_enabled_disabled_dh)
STD_PHP_INI_ENTRY_EX("newrelic.browser_monitoring.attributes.enabled",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.browser_monitoring_attributes.enabled,
                     zend_newrelic_globals,
                     newrelic_globals,
                     nr_enabled_disabled_dh)
STD_PHP_INI_ENTRY_EX("newrelic.browser_monitoring.attributes.include",
                     ...
                     NR_PHP_REQUEST,
                     nr_string_mh,
                     ini.browser_monitoring_attributes.include,
                     zend_newrelic_globals,
                     newrelic_globals,
                     0)
STD_PHP_INI_ENTRY_EX("newrelic.browser_monitoring.attributes.exclude",
                     ...
                     NR_PHP_REQUEST,
                     nr_string_mh,
                     ini.browser_monitoring_attributes.exclude,
                     zend_newrelic_globals,
                     newrelic_globals,
                     0)
/*
...
STD_PHP_INI_ENTRY_EX("newrelic.allow_raw_exception_messages",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.allow_raw_exception_messages,
                     zend_newrelic_globals,
                     newrelic_globals,
                     0)
...
STD_PHP_INI_ENTRY_EX("newrelic.distributed_tracing_enabled",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.distributed_tracing_enabled,
                     zend_newrelic_globals,
                     newrelic_globals,
                     0)
...
STD_PHP_INI_ENTRY_EX("newrelic.distributed_tracing_exclude_newrelic_header",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.distributed_tracing_exclude_newrelic_header,
                     zend_newrelic_globals,
                     newrelic_globals,
                     0)
...
STD_PHP_INI_ENTRY_EX(
    ...
    NR_PHP_REQUEST,
    nr_dt_sampler_remote_parent_mh,
    ini.dt_remote_parent_not_sampled,
    zend_newrelic_globals,
    newrelic_globals,
    0)
...
STD_PHP_INI_ENTRY_EX("newrelic.span_events.max_samples_stored",
                     ...
                     ini.span_events_max_samples_stored,
                     zend_newrelic_globals,
                     newrelic_globals,
                     0)
...
STD_PHP_INI_ENTRY_EX("newrelic.span_events.attributes.enabled",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.span_events_attributes.enabled,
                     zend_newrelic_globals,
                     newrelic_globals,
                     nr_enabled_disabled_dh)
STD_PHP_INI_ENTRY_EX("newrelic.span_events.attributes.include",
                     ...
                     NR_PHP_REQUEST,
                     nr_string_mh,
                     ini.span_events_attributes.include,
                     zend_newrelic_globals,
                     newrelic_globals,
                     0)
STD_PHP_INI_ENTRY_EX("newrelic.span_events.attributes.exclude",
                     ...
                     NR_PHP_REQUEST,
                     nr_string_mh,
                     ini.span_events_attributes.exclude,
                     zend_newrelic_globals,
                     newrelic_globals,
                     0)
...
STD_PHP_INI_ENTRY_EX("newrelic.code_level_metrics.enabled",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.code_level_metrics_enabled,
                     zend_newrelic_globals,
                     newrelic_globals,
                     nr_enabled_disabled_dh)
/*
...
STD_PHP_INI_ENTRY_EX(
    ...
    ini.log_events_max_samples_stored,
    zend_newrelic_globals,
    newrelic_globals,
    0)
...
STD_PHP_INI_ENTRY_EX(
    ...
    NR_PHP_REQUEST,
    nr_boolean_mh,
    ini.log_context_data_attributes.enabled,
    zend_newrelic_globals,
    newrelic_globals,
    nr_enabled_disabled_dh)
STD_PHP_INI_ENTRY_EX(
    ...
    NR_PHP_REQUEST,
    nr_string_mh,
    ini.log_context_data_attributes.include,
    zend_newrelic_globals,
    newrelic_globals,
    0)
STD_PHP_INI_ENTRY_EX(
    ...
    NR_PHP_REQUEST,
    nr_string_mh,
    ini.log_context_data_attributes.exclude,
    zend_newrelic_globals,
    newrelic_globals,
    0)
STD_PHP_INI_ENTRY_EX("newrelic.application_logging.forwarding.labels.enabled",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.log_forwarding_labels_enabled,
                     zend_newrelic_globals,
                     newrelic_globals,
                     nr_enabled_disabled_dh)
STD_PHP_INI_ENTRY_EX("newrelic.application_logging.forwarding.labels.exclude",
                     ...
                     NR_PHP_REQUEST,
                     nr_string_mh,
                     ini.log_forwarding_labels_exclude,
                     zend_newrelic_globals,
                     newrelic_globals,
                     0)
...
STD_PHP_INI_ENTRY_EX(
    ...
    NR_PHP_REQUEST,
    nr_boolean_mh,
    ini.vulnerability_management_package_detection_enabled,
    zend_newrelic_globals,
    newrelic_globals,
    nr_enabled_disabled_dh)
...
STD_PHP_INI_ENTRY_EX("newrelic.vulnerability_management.composer_api.enabled",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.vulnerability_management_composer_api_enabled,
                     zend_newrelic_globals,
                     newrelic_globals,
                     nr_enabled_disabled_dh)
...
STD_PHP_INI_ENTRY_EX("newrelic.message_tracer.segment_parameters.enabled",
                     ...
                     NR_PHP_REQUEST,
                     nr_boolean_mh,
                     ini.message_tracer_segment_parameters_enabled,
                     zend_newrelic_globals,
                     newrelic_globals,
                     nr_enabled_disabled_dh)
